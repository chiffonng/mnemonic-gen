...
\usepackage{enumitem} % For custom list styles, for tcolorbox
\usepackage{xspace}
...
\newcommand{\links}{\textbf{\textsc{Links}}\xspace}
\newcommand{\linksys}{\textbf{\textsc{LinkSYS}}\xspace}
\newcommand{\lgms}{linguistically grounded mnemonics\xspace}
\newcommand{\lgm}{linguistically grounded mnemonic\xspace}
\newcommand{\studentmodel}{Gemma-3-1b-it\xspace}
\newcommand{\xstudentmodel}{gemma-3-4b-it\xspace}
\newcommand{\teachermodel}{DeepSeek-R1\xspace}
\newcommand{\xteachermodel}{DeepSeek-V3\xspace}
\newcommand{\judgemodel}{OpenAI's o3-mini\xspace}
\newcommand{\mnemonic}{\textcolor{orange}{mnemonic}\xspace}
\newcommand{\vocabulary}{\textcolor{red}{vocabulary}\xspace}
\newcommand{\association}{\textcolor{goodgreen}{association}\xspace}
\newcommand{\mnem}{$m$\xspace}
\newcommand{\vocab}{$v$\xspace}
\newcommand{\assoc}{$a$\xspace}
